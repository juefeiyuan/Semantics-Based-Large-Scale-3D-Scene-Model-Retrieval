...
def get_arguments():
    ...
    parser.add_argument('--backbone', choices=['alexnet','vgg11_bn','resnet50','resnet101','vgg13_bn', 'vgg16_bn'],default='vgg11_bn')
    ...
    # TODO
    # Below is the current path used to access the data
    '''parser.add_argument('--train_shape_views_folder', type=str, default='demo_data/Views')
    parser.add_argument('--test_shape_views_folder', type=str, default='demo_data/Views')
    parser.add_argument('--train_shape_flist', type=str, default='demo_data/lists/model_train_pair.txt',
                        help='path to a list file that records the path and label of each sample')
    parser.add_argument('--test_shape_flist', type=str, default='demo_data/lists/model_test_pair.txt',
                        help='path to a list file that records the path and label of each sample')

    parser.add_argument('--train_sketch_folder', type=str, default='demo_data/Sketches')
    parser.add_argument('--test_sketch_folder', type=str, default='demo_data/Sketches')
    parser.add_argument('--train_sketch_flist', type=str, default='demo_data/lists/sketch_train_pair.txt',
                        help='path to a list file that records the path and label of each sample')
    parser.add_argument('--test_sketch_flist', type=str, default='demo_data/lists/sketch_test_pair.txt',
                        help='path to a list file that records the path and label of each sample')'''

    parser.add_argument('--train_shape_views_folder', type=str,
                        default='shrec19/train/Views')
    parser.add_argument('--test_shape_views_folder', type=str,
                        default='shrec19/test/Views')
    parser.add_argument('--train_shape_flist', type=str,
                        default='shrec19/train/lists/model_train_pair.txt',
                        help='path to a list file that records the path and label of each sample')
    parser.add_argument('--test_shape_flist', type=str,
                        default='shrec19/test/lists/model_test_pair.txt',
                        help='path to a list file that records the path and label of each sample')

    parser.add_argument('--train_sketch_folder', type=str,
                        default='shrec19/train/Sketches')
    parser.add_argument('--test_sketch_folder', type=str,
                        default='shrec19/test/Sketches')
    parser.add_argument('--train_sketch_flist', type=str,
                        default='shrec19/train/lists/sketch_train_pair.txt',
                        help='path to a list file that records the path and label of each sample')
    parser.add_argument('--test_sketch_flist', type=str,
                        default='shrec19/test/lists/sketch_test_pair.txt',
                        help='path to a list file that records the path and label of each sample')
